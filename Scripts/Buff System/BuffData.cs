using UnityEngine;
/// <summary>
/// BuffData is a class that can be used to create a basic buff on any EntityStats object.
/// this basic buff will either heal or damage the owner, and expires after a certain duration
/// </summary>
/// 
...
public class BuffData : ScriptableObject
{
    ...
    public class Stats
    {
        ...
        [Tooltip("Whether this buff slows down or speeds up animation")]
        ...
        [Tooltip("Controls how frequently the damage / heal per socond applies.")]
