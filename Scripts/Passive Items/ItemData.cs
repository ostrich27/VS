using UnityEngine;
/// <summary>
/// base class for all weapons / passive items. the base class is used so that both WeaponData and
/// PassiveItemData  are able to be used interchangeably if required.
/// </summary>
